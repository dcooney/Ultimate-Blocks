...
function OutsideAlerter(props) {
	...
	console.log("can this be skipped?");
	console.log(`visibility trigger: ${props.visibilityTrigger}`);
...
const URLInputBox = (props) => {
	...
	useEffect(() => {
		console.log("another mounting listener");
...
export function NewEditorComponent(props) {
	const {
		isSelected,
		block,
		setAttributes,
	...
	function loadIconList() {
		...
		console.log("loading existing icon list...");
